    ...
    static function on_td_global_after_config() {
	    ...
	    td_global::$demo_list = array (
            ...
            'magazine' => array(
                ...
                'demo_url' => 'http://demo.tagdiv.com/newsmag_magazine/',
            ...
            'food' => array(
                'text' => 'Food',
                'folder' => td_global::$get_template_directory . '/includes/demos/food/',
                'img' => td_global::$get_template_directory_uri . '/includes/demos/food/screenshot.png',
                'demo_url' => 'http://demo.tagdiv.com/newsmag_food/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'scandal' => array(
            ...
            'voice' => array(
                ...
                'demo_url' => 'http://demo.tagdiv.com/newsmag_voice/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'sound_square' => array(
                'text' => 'Sound Square',
                'folder' => td_global::$get_template_directory . '/includes/demos/sound_square/',
                'img' => td_global::$get_template_directory_uri . '/includes/demos/sound_square/screenshot.png',
                'demo_url' => 'http://demo.tagdiv.com/newsmag_sound_square/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'animals' => array(
